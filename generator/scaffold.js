...
const SKELETON_PACKAGE_TYPE_FOLDER = `${SKELETON_FOLDER}/types/components`;
...
const SRC_COMPONENTS_TYPE_FOLDER = `${SKELETON_PACKAGE_TYPE_FOLDER}`;
...
const TARGET_COMPONENTS_PACKAGE_TYPE_FOLDER = `${COMPONENT_PACKAGE_TYPE_FOLDER}`;
...
const SRC_COMPONENTS_PACKAGE_TYPE = `${SRC_COMPONENTS_TYPE_FOLDER}/${SKELETON_COMPONENT_NAME}.${TYPES_EXTENSION}`;
...
const TARGET_COMPONENTS_PACKAGE_TYPE = `${TARGET_COMPONENTS_PACKAGE_TYPE_FOLDER}/${NEW_COMPONENT_NAME}.${TYPES_EXTENSION}`;
...
const FILES = [
  ...
  [SRC_COMPONENTS_PACKAGE_TYPE, TARGET_COMPONENTS_PACKAGE_TYPE],
];
